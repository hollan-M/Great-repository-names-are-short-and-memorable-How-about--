...
trigger.addEventListener("click", (e) => {
    ...
    create_text("PEEP THESE GIFS BRO!!", text_div, (parent: HTMLDivElement, text: HTMLAnchorElement[])=>{ 
        let div_parent = parent.parentElement!;
    ...
    create_text("VIDEO STUFF!!", video_div, (parent: HTMLDivElement, text: HTMLAnchorElement[])=>{ 
        let div_parent = parent.parentElement!;
    ...
    create_text("SEAHORSE SERENITY", seahorse_div, (parent: HTMLDivElement, text: HTMLAnchorElement[])=>{ 
        let div_parent = parent.parentElement!;
